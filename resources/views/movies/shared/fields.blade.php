...
<div class="flex flex-wrap space-x-8">
    <div class="grow mt-6 space-y-4">
        <x-field.input name="title" label="Title" :readonly="$readonly" :required="true" value="{{ old('title', $movie->title) }}" />
        <x-field.image
        name="photo_file"
        label="Photo"
        width="md"
        ...
        <x-field.input name="trailer_url" label="Trailer_url" :readonly="$readonly" value="{{ old('trailer_url', $movie->trailer_url) }}" />
    </div>
</div>
